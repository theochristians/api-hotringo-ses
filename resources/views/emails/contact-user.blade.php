...
<head>
    <meta charset="UTF-8">
    <title>Terima kasih sudah menghubungi hotringo.tech</title>
                ...
                <tr>
                    <td class="section-padding" style="padding:8px 28px 4px 28px;">
                        <div class="title-text"
                            ...
                            Terima kasih, {{ $data['name'] ?? 'Pengunjung' }} 👋
                        </div>
                        <div class="intro-text"
                             style="font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;
                                    font-size:13px;color:#4b5563;text-align:left;margin-top:6px;line-height:1.6;">
                            Kami telah menerima pesan Anda melalui formulir kontak di website
                            <strong>hotringo.tech</strong>. Tim kami akan meninjau permintaan Anda dan
                            berusaha membalas maksimal dalam <strong>1×24 jam (hari kerja)</strong>.
                        </div>
                    </td>
                </tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div style="font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;
                                                    ...
                                                    Tanggal pengiriman: {{ now()->format('d M Y, H:i') }} (waktu server)
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td style="background-color:#f9fafb;border-top:1px solid #e5e7eb;padding:18px 24px 20px 24px;">
                        ...
                        <div style="font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;
                            ...
                            Anda tidak perlu membalas email ini. Jika diperlukan, tim <strong>hotringo.tech</strong>
                            akan menghubungi Anda kembali melalui alamat email yang Anda cantumkan untuk
                            mendiskusikan detail proyek atau pertanyaan Anda.
                        </div>
                        <div style="font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;
                                    font-size:11px;color:#6b7280;line-height:1.6;">
                            Email ini dikirim otomatis sebagai konfirmasi bahwa formulir kontak Anda telah kami terima.
                            Jika Anda merasa tidak pernah mengisi formulir di website kami, Anda dapat mengabaikan email ini.<br><br>
